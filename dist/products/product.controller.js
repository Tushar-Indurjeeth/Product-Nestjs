...
let ProductController = class ProductController {
    ...
    async createProduct(response, createProductDto) {
        try {
    ...
    async updateProduct(response, productId, updateProductDto) {
        try {
    ...
    async getProducts(response) {
        try {
            ...
            return response.status(common_1.HttpStatus.OK).json(Object.assign({ message: 'All products data found successfully' }, productData));
        }
        catch (err) {
            return response.status(err.status).json(err.response);
        }
